namespace BasicRotations.Healer;
...
public sealed class AST_Default : AST_Base
{
    ...
    protected override IRotationConfigSet CreateConfiguration()
        => base.CreateConfiguration()
            .SetFloat(EasyCombat.Basic.Configuration.ConfigUnitType.Seconds, CombatType.PvE, "UseEarthlyStarTime", 15, "Use Earthly Star during countdown timer.", 4, 20);
    #endregion
